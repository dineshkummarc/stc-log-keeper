                ...
                <div class="col-lg-12">
                  <div class="card">
                   ...
                   <div class="card-header d-flex align-items-right">
                      <h3 class="h4">
                      <!--a href="print_reports_prev.php?selectedMM=<?php //echo $selectedMM; ?>&selectedDD=<?php //echo $selectedDD; ?>&selectedYYYY=<?php //echo $selectedYYYY; ?>" target="_blank" class="btn btn-info btn-sm" style="color: white;"><i class="fa fa-print"></i></a-->
