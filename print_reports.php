                  ...
                  <div class="logo">
                    ...
                    <div class="dropdown" style="margin-bottom: 12px;">
                      ...
                      <div class="dropdown-content">
                        ...
                        <a href="#"><i class="fa fa-list"></i> View Logs</a>
                ...
                <div class="col-lg-12">
                  <div class="card">
                   ...
                   <div class="card-header d-flex align-items-right">
                      <h3 class="h4"><a href="print_reports_prev.php?selectedMM=<?php echo $selectedMM; ?>&selectedDD=<?php echo $selectedDD; ?>&selectedYYYY=<?php echo $selectedYYYY; ?>" target="_blank" class="btn btn-info btn-sm" style="color: white;"><i class="fa fa-print"></i></a> DAILY LOG RECORDS</h3>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">  
                        <table class="table table-striped" id="example">
                          ...
                          $chk_log_in_query->execute(['date_mm' => $selectedMM, 'date_dd' => $selectedDD, 'date_yyyy' => $selectedYYYY]);
